...
public class ScaleSpringAnimation {
    ...
    public ScaleSpringAnimation(ImageView animateView, TextView infoView) {
        ...
        scaleXAnimation = SpringAnimationUtil.createSpringAnimation(animateView, SpringAnimation.SCALE_X,
                INITIAL_SCALE, SpringForce.STIFFNESS_MEDIUM, SpringForce.DAMPING_RATIO_HIGH_BOUNCY);
        scaleYAnimation = SpringAnimationUtil.createSpringAnimation(animateView, SpringAnimation.SCALE_Y,
                INITIAL_SCALE, SpringForce.STIFFNESS_MEDIUM, SpringForce.DAMPING_RATIO_HIGH_BOUNCY);
        updateInfoView();
        setupPinchToZoom();
